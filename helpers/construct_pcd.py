...
mesh = o3d.io.read_triangle_mesh(os.path.join(OBJS_DIR, "banana.obj"))
...
pcd = pcd.select_by_index(np.where(pcd.points[:, 2] > 0)[0])
transformed_pcd = transformed_mesh.sample_points_uniformly(number_of_points=500)
o3d.visualization.draw_geometries([pcd, transformed_pcd])

o3d.io.write_point_cloud("/Users/adibalaji/Desktop/UMICH-24-25/manip/sdf_localization/pcd/transformed_banana_cropped.pcd", pcd)
