...
mesh = o3d.io.read_triangle_mesh(os.path.join(OBJS_DIR, "hammer.obj"))
...
pcd_np = pcd_np[pcd_np[:, 2] > 0.0115]
pcd.points = o3d.utility.Vector3dVector(pcd_np)

transformed_pcd = transformed_mesh.sample_points_uniformly(number_of_points=1000)
o3d.visualization.draw_geometries([pcd])

o3d.io.write_point_cloud("/Users/adibalaji/Desktop/UMICH-24-25/manip/sdf_localization/pcd/partial_view_hammer.pcd", pcd)
